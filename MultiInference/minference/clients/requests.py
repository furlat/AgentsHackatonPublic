...
class OpenAIRequest(BaseModel):
    ...
    def validate_max_completion_tokens(self) -> Self:
        if self.model in ["o1","o1-mini","o3-mini","o1-preview"] and self.max_tokens is not None:
            raise ValueError("max_tokens is not allowed for oai reasoning models you need to use max_completion_tokens instead")
        elif self.model in ["o1","o1-mini","o3-mini","o1-preview"] and self.max_completion_tokens is None:
            raise ValueError("max_completion_tokens is required for oai reasoning models")
        elif self.model not in ["o1","o1-mini","o3-mini","o1-preview"] and self.max_completion_tokens is not None:
